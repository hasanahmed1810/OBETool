...
class CLOAttainmentChart extends BaseChart
{
    ...
    {   
        $total_students = Student::where('subject_id', Session::get('subject_id_for_clo'))->get()->count();
        $students_who_passed_1 = Student::where('subject_id', Session::get('subject_id_for_clo'))->get()->where('clo1', '>=', 40)->count();
        $students_who_passed_1_percentage = ($students_who_passed_1/$total_students)*100;
        $students_who_passed_2 = Student::where('subject_id', Session::get('subject_id_for_clo'))->get()->where('clo2', '>=', 40)->count();
        $students_who_passed_2_percentage = ($students_who_passed_2/$total_students)*100;
        $students_who_passed_3 = Student::where('subject_id', Session::get('subject_id_for_clo'))->get()->where('clo3', '>=', 40)->count();
        $students_who_passed_3_percentage = ($students_who_passed_3/$total_students)*100;
        $students_who_passed_4 = Student::where('subject_id', Session::get('subject_id_for_clo'))->get()->where('clo4', '>=', 40)->count();
