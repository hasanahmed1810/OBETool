<x-app-layout>
    ...
    <label class="transition ease-in-out delay-15 hover:-translate-y-1 w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer">
        ...
        <div class='flex w-full h-24 items-center justify-center bg-grey-lighter'>
         <button class='transition ease-in-out delay-15 hover:-translate-y-1 w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer' type="submit">UPLOAD</button>
        </div>
    </div>
    </form>
</x-app-layout>
